...
// Initialize initializes and returns a formatter based on the specified format type.
// This is the single entry point for creating formatters, following the initialization
// pattern used throughout Thunder (similar to authn/credentials/init.go).
//
