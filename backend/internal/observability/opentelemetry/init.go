...
// Initialize initializes and returns an OpenTelemetry TracerProvider.
// This is the single entry point for creating tracer providers, following the
// initialization pattern used throughout Thunder (similar to authn/credentials/init.go).
//
// The function creates and configures a TracerProvider based on the provided configuration,
