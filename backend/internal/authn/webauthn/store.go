...
type sessionStoreInterface interface {
	...
	retrieveSession(sessionKey string) (*webauthn.SessionData, string, string, error)
...
func (s *sessionStore) storeSession(sessionKey, userID, relyingPartyID string,
	sessionData *webauthn.SessionData, expiryTime time.Time) error {
...
func (s *sessionStore) retrieveSession(sessionKey string) (*webauthn.SessionData, string, string, error) {
	if sessionKey == "" {
		return nil, "", "", nil
	}
...
func (s *sessionStore) serializeSessionData(sessionData *webauthn.SessionData) ([]byte, error) {
...
) (*webauthn.SessionData, string, string, error) {
