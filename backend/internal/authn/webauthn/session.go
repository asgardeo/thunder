...
// storeSessionData stores WebAuthn session data in the database and returns a session key.
func (w *webAuthnAuthnService) storeSessionData(
	userID, relyingPartyID string, sessionData *webauthn.SessionData,
...
func (w *webAuthnAuthnService) retrieveSessionData(
	sessionKey string,
) (*webauthn.SessionData, string, string, *serviceerror.ServiceError) {
...
func (w *webAuthnAuthnService) clearSessionData(sessionKey string) {
