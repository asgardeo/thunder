...
var (
	...
	// ErrorEmptyPermissions is the error returned when permissions list is empty.
	ErrorEmptyPermissions = serviceerror.ServiceError{
		Type:             serviceerror.ClientErrorType,
		Code:             "ROL-1013",
		Error:            "Empty permissions list",
		ErrorDescription: "A role must have at least one permission",
	}
