...
func (suite *RoleHandlerTestSuite) TestHandleRoleListRequest_DefaultPagination() {
	expectedResponse := &RoleListResponse{
		...
		StartIndex:   1,
		Count:        1,
		Roles:        []RoleSummary{{ID: "role1", Name: "Admin"}},
		Links:        []Link{},
	}
...
func (suite *RoleHandlerTestSuite) TestHandleRolePostRequest_Success() {
	...
	suite.mockService.On("CreateRole", mock.AnythingOfType("CreateRoleRequest")).Return(expectedRole, nil)
...
func (suite *RoleHandlerTestSuite) TestHandleRolePostRequest_ServiceError() {
	...
	suite.mockService.On("CreateRole", mock.AnythingOfType("CreateRoleRequest")).
...
func (suite *RoleHandlerTestSuite) TestHandleRoleGetRequest_Success() {
	...
	suite.mockService.On("GetRole", "role1").Return(expectedRole, nil)
...
func (suite *RoleHandlerTestSuite) TestHandleRoleGetRequest_NotFound() {
	suite.mockService.On("GetRole", "nonexistent").Return(nil, &ErrorRoleNotFound)
...
func (suite *RoleHandlerTestSuite) TestHandleRolePutRequest_Success() {
	...
	suite.mockService.On("UpdateRole", "role1", mock.AnythingOfType("UpdateRoleRequest")).Return(updatedRole, nil)
...
func (suite *RoleHandlerTestSuite) TestHandleRoleAssignmentsGetRequest_Success() {
	expectedResponse := &AssignmentListResponse{
		TotalResults: 2,
		StartIndex:   1,
		Count:        2,
	...
	suite.mockService.On("GetRoleAssignments", "role1", 10, 0).Return(expectedResponse, nil)
...
func (suite *RoleHandlerTestSuite) TestHandleRoleAssignmentsGetRequest_RoleNotFound() {
	suite.mockService.On("GetRoleAssignments", "nonexistent", 30, 0).Return(nil, &ErrorRoleNotFound)
...
func (suite *RoleHandlerTestSuite) TestHandleRoleAddAssignmentsRequest_Success() {
	...
	suite.mockService.On("AddAssignments", "role1", mock.AnythingOfType("AssignmentsRequest")).Return(nil)
...
func (suite *RoleHandlerTestSuite) TestHandleRoleAddAssignmentsRequest_ServiceError() {
	...
	suite.mockService.On("AddAssignments", "role1", mock.AnythingOfType("AssignmentsRequest")).
...
func (suite *RoleHandlerTestSuite) TestHandleRoleRemoveAssignmentsRequest_Success() {
	...
	suite.mockService.On("RemoveAssignments", "role1", mock.AnythingOfType("AssignmentsRequest")).Return(nil)
...
func (suite *RoleHandlerTestSuite) TestHandleRolePutRequest_RoleNotFound() {
	...
	suite.mockService.On("UpdateRole", "nonexistent", mock.AnythingOfType("UpdateRoleRequest")).
...
func (suite *RoleHandlerTestSuite) TestHandleRoleAddAssignmentsRequest_RoleNotFound() {
	...
	suite.mockService.On("AddAssignments", "nonexistent", mock.AnythingOfType("AssignmentsRequest")).
...
func (suite *RoleHandlerTestSuite) TestHandleRoleRemoveAssignmentsRequest_RoleNotFound() {
	...
	suite.mockService.On("RemoveAssignments", "nonexistent", mock.AnythingOfType("AssignmentsRequest")).
		Return(&ErrorRoleNotFound)
...
func (suite *RoleHandlerTestSuite) TestHandleRoleRemoveAssignmentsRequest_ServiceError() {
	...
	suite.mockService.On("RemoveAssignments", "role1", mock.AnythingOfType("AssignmentsRequest")).
		Return(&ErrorInvalidAssignmentID)
