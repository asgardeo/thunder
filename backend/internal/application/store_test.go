...
// StoreUnitTestSuite contains unit tests for store functions with mocked database
type StoreUnitTestSuite struct {
	suite.Suite
...
func TestStoreUnitTestSuite(t *testing.T) {
	suite.Run(t, new(StoreUnitTestSuite))
}

func (suite *StoreUnitTestSuite) SetupTest() {
	suite.mockDBClient = clientmock.NewDBClientInterfaceMock(suite.T())
}

//nolint:unparam // id parameter is kept for flexibility even though currently always "app1"
func (suite *ApplicationStoreTestSuite) createTestApplication(id, name string) model.ApplicationProcessedDTO {
...
func (suite *ApplicationStoreTestSuite) TestGetOAuthConfigJSONBytes_Success() {
	...
	suite.True(ok)
	suite.Equal("access-token-issuer", accessToken["issuer"])
...
func (suite *ApplicationStoreTestSuite) TestBuildApplicationFromResultRow_WithContactsNonStringElement() {
	...
	// Non-string elements should be skipped
	suite.NoError(err)
	suite.Len(result.Contacts, 2) // Only string elements
	suite.Equal("contact@example.com", result.Contacts[0])
	suite.Equal("support@example.com", result.Contacts[1])
}
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_WithComplexTokenConfig() {
	...
	suite.Assert().Equal("https://access-issuer.example.com", result.Token.AccessToken.Issuer)
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_WithNilTokenConfig() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_WithJSONAsBytes() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_WithNilJSON() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_NotFound() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_DatabaseError() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_InvalidAppIDType() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_InvalidJSONType() {
...
func (suite *StoreUnitTestSuite) TestGetOAuthApplication_MalformedJSON() {
