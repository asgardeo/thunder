...
func (_mock *GroupServiceInterfaceMock) GetEligibleMembers(ctx context.Context, groupID string, memberType MemberType, limit int, offset int) (*EligibleMemberListResponse, *serviceerror.ServiceError) {
	...
	var r0 *EligibleMemberListResponse
	var r1 *serviceerror.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, MemberType, int, int) (*EligibleMemberListResponse, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, groupID, memberType, limit, offset)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, MemberType, int, int) *EligibleMemberListResponse); ok {
		r0 = returnFunc(ctx, groupID, memberType, limit, offset)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*EligibleMemberListResponse)
		}
	}
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, MemberType, int, int) *serviceerror.ServiceError); ok {
...
func (_c *GroupServiceInterfaceMock_GetEligibleMembers_Call) Run(run func(ctx context.Context, groupID string, memberType MemberType, limit int, offset int)) *GroupServiceInterfaceMock_GetEligibleMembers_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *GroupServiceInterfaceMock_GetEligibleMembers_Call) Return(eligibleMemberListResponse *EligibleMemberListResponse, serviceError *serviceerror.ServiceError) *GroupServiceInterfaceMock_GetEligibleMembers_Call {
	_c.Call.Return(eligibleMemberListResponse, serviceError)
	return _c
}

func (_c *GroupServiceInterfaceMock_GetEligibleMembers_Call) RunAndReturn(run func(ctx context.Context, groupID string, memberType MemberType, limit int, offset int) (*EligibleMemberListResponse, *serviceerror.ServiceError)) *GroupServiceInterfaceMock_GetEligibleMembers_Call {
	_c.Call.Return(run)
	return _c
}
