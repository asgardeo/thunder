...
type GroupServiceInterface interface {
	...
	GetGroupsByPath(ctx context.Context, handlePath string,
		limit, offset int) (*GroupListResponse, *serviceerror.ServiceError)
	CreateGroup(ctx context.Context, request CreateGroupRequest) (*Group, *serviceerror.ServiceError)
	CreateGroupByPath(ctx context.Context, handlePath string,
		request CreateGroupByPathRequest) (*Group, *serviceerror.ServiceError)
	...
	GetGroupMembers(ctx context.Context, groupID string,
		limit, offset int) (*MemberListResponse, *serviceerror.ServiceError)
...
// integer
func (gs *groupService) GetGroupList(ctx context.Context,
	limit, offset int) (*GroupListResponse, *serviceerror.ServiceError) {
...
func (gs *groupService) CreateGroup(ctx context.Context,
	request CreateGroupRequest) (*Group, *serviceerror.ServiceError) {
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, loggerComponentName))
