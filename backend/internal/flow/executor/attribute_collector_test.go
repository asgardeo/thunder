...
func (suite *AttributeCollectorTestSuite) TestExecute_Success() {
	...
	suite.mockEntityProvider.On("GetEntity", testUserID).Return(existingUser, nil)
	suite.mockEntityProvider.On("UpdateEntity", testUserID, mock.MatchedBy(func(u *entityprovider.Entity) bool {
...
func (suite *AttributeCollectorTestSuite) TestExecute_UpdateUserFails() {
	...
	suite.mockEntityProvider.On("GetEntity", testUserID).Return(existingUser, nil)
	suite.mockEntityProvider.On("UpdateEntity", testUserID, mock.Anything).
		Return(nil, &entityprovider.EntityProviderError{Message: "update failed"})
