...
const (
	identityResolverLoggerComponentName = "IdentityResolverExecutor"
)
...
func newIdentityResolverExecutor(
	...
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, identityResolverLoggerComponentName),
