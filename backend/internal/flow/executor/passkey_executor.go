...
const (
	// nolint:gosec // G101: This is a logger component name, not a credential
	passkeyAuthLoggerComponentName = "PasskeyAuthExecutor"
...
func newPasskeyAuthExecutor(
	...
	logger := log.GetLogger().With(log.String(log.LoggerKeyComponentName, passkeyAuthLoggerComponentName),
