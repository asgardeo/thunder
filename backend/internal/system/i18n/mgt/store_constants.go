...
var (
	...
	// queryDeleteTranslationsByNamespaceAndKey deletes all translations for a given namespace and key.
	queryDeleteTranslationsByNamespaceAndKey = dbmodel.DBQuery{
		ID:    "I18N-11",
