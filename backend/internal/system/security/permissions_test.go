...
func TestHasSystemPermission(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, HasSystemPermission(tt.permissions))
		})
	}
}
...
func TestHasSufficientPermission(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want, HasSufficientPermission(tt.userPermissions, tt.required))
		})
	}
}
...
func TestResolveActionPermission(t *testing.T) {
	tests := []struct {
		name     string
		action   Action
		wantPerm string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.wantPerm, ResolveActionPermission(tt.action))
		})
	}
}
...
func TestResolveActionPermission_CoversAllMappedActions(t *testing.T) {
	for action, expectedPerm := range actionPermissionMap {
		t.Run(string(action), func(t *testing.T) {
			assert.Equal(t, expectedPerm, ResolveActionPermission(action))
		})
	}
}
