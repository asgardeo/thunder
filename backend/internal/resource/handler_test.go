...
func (suite *HandlerTestSuite) TestHandleActionListAtResourceServerRequest_Success() {
	...
	suite.mockService.On("GetActionListAtResourceServer", "rs-123", 30, 0).Return(&ActionList{
		TotalResults: 2,
		StartIndex:   1,
		Count:        2,
		Actions:      actions,
...
func (suite *HandlerTestSuite) TestHandleActionPostAtResourceServerRequest_Success() {
	...
	suite.mockService.On("CreateActionAtResourceServer", "rs-123", mock.Anything).Return(&Action{
		ID:     "action-123",
		Name:   "test-action",
		Handle: "test-handle",
	}, nil)
...
func (suite *HandlerTestSuite) TestHandleActionGetAtResourceServerRequest_Success() {
	suite.mockService.On("GetActionAtResourceServer", "rs-123", "action-123").Return(&Action{
		ID:   "action-123",
		Name: "test-action",
	}, nil)
...
func (suite *HandlerTestSuite) TestHandleActionPutAtResourceServerRequest_Success() {
	...
	suite.mockService.On("UpdateActionAtResourceServer", "rs-123", "action-123", mock.Anything).Return(&Action{
		ID:          "action-123",
		Description: "updated description",
	}, nil)
...
func (suite *HandlerTestSuite) TestHandleActionDeleteAtResourceServerRequest_Success() {
	suite.mockService.On("DeleteActionAtResourceServer", "rs-123", "action-123").Return(nil)
...
func (suite *HandlerTestSuite) TestHandleActionListAtResourceRequest_Success() {
	...
	suite.mockService.On("GetActionListAtResource", "rs-123", "res-123", 30, 0).Return(&ActionList{
		TotalResults: 1,
		Actions:      actions,
	}, nil)
...
func (suite *HandlerTestSuite) TestHandleActionPostAtResourceRequest_Success() {
	...
	suite.mockService.On("CreateActionAtResource", "rs-123", testResourceID, mock.Anything).Return(&Action{
		ID:         "action-123",
		Name:       "test-action",
		Handle:     "test-handle",
...
func (suite *HandlerTestSuite) TestHandleActionGetAtResourceRequest_Success() {
	resourceID := testResourceID
	suite.mockService.On("GetActionAtResource", "rs-123", testResourceID, "action-123").Return(&Action{
		ID:         "action-123",
		Name:       "test-action",
		ResourceID: &resourceID,
	}, nil)
...
func (suite *HandlerTestSuite) TestHandleActionPutAtResourceRequest_Success() {
	...
	suite.mockService.On("UpdateActionAtResource", "rs-123", testResourceID, "action-123", mock.Anything).Return(&Action{
		ID:          "action-123",
		Name:        "test-action",
		Description: "Updated description",
	}, nil)
...
func (suite *HandlerTestSuite) TestHandleActionPutAtResourceRequest_NotFound() {
	...
	suite.mockService.On("UpdateActionAtResource", "rs-123", testResourceID, "action-123",
...
func (suite *HandlerTestSuite) TestHandleActionDeleteAtResourceRequest_Success() {
	suite.mockService.On("DeleteActionAtResource", "rs-123", testResourceID, "action-123").Return(nil)
...
func (suite *HandlerTestSuite) TestHandleActionDeleteAtResourceRequest_NotFound() {
	suite.mockService.On("DeleteActionAtResource", "rs-123", testResourceID, "action-123").Return(&ErrorActionNotFound)
...
func (suite *HandlerTestSuite) TestHandleActionDeleteAtResourceRequest_ServiceError() {
	suite.mockService.On("DeleteActionAtResource", "rs-123", testResourceID, "action-123").
...
func (suite *HandlerTestSuite) TestHandleActionListAtResourceServerRequest_ServiceError() {
	suite.mockService.On("GetActionListAtResourceServer", "rs-123", 30, 0).Return(nil, &serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionPostAtResourceServerRequest_ServiceError() {
	...
	suite.mockService.On("CreateActionAtResourceServer", "rs-123", mock.Anything).
		Return(nil, &serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionGetAtResourceServerRequest_NotFound() {
	suite.mockService.On("GetActionAtResourceServer", "rs-123", "action-123").Return(nil, &ErrorActionNotFound)
...
func (suite *HandlerTestSuite) TestHandleActionGetAtResourceServerRequest_ServiceError() {
	suite.mockService.On("GetActionAtResourceServer", "rs-123", "action-123").
		Return(nil, &serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionPutAtResourceServerRequest_ServiceError() {
	...
	suite.mockService.On("UpdateActionAtResourceServer", "rs-123", "action-123",
		mock.Anything).Return(nil, &serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionDeleteAtResourceServerRequest_ServiceError() {
	suite.mockService.On("DeleteActionAtResourceServer", "rs-123", "action-123").Return(&serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionListAtResourceRequest_ServiceError() {
	suite.mockService.On("GetActionListAtResource", "rs-123", testResourceID, 30, 0).
		Return(nil, &serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionPostAtResourceRequest_ServiceError() {
	...
	suite.mockService.On("CreateActionAtResource", "rs-123", testResourceID, mock.Anything).
		Return(nil, &serviceerror.InternalServerError)
...
func (suite *HandlerTestSuite) TestHandleActionGetAtResourceRequest_NotFound() {
	suite.mockService.On("GetActionAtResource", "rs-123", testResourceID, "action-123").Return(nil, &ErrorActionNotFound)
...
func (suite *HandlerTestSuite) TestHandleActionGetAtResourceRequest_ServiceError() {
	suite.mockService.On("GetActionAtResource", "rs-123", testResourceID, "action-123").
		Return(nil, &serviceerror.InternalServerError)
