...
func (h *resourceHandler) HandleResourceServerListRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetResourceServerList(r.Context(), limit, offset)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceServerPostRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.CreateResourceServer(r.Context(), serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceServerGetRequest(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	result, svcErr := h.resourceService.GetResourceServer(r.Context(), id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceServerPutRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.UpdateResourceServer(r.Context(), id, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceServerDeleteRequest(w http.ResponseWriter, r *http.Request) {
	id := r.PathValue("id")
	svcErr := h.resourceService.DeleteResourceServer(r.Context(), id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceListRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetResourceList(r.Context(), rsID, parentID, limit, offset)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourcePostRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.CreateResource(r.Context(), rsID, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceGetRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetResource(r.Context(), rsID, id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourcePutRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.UpdateResource(r.Context(), rsID, id, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleResourceDeleteRequest(w http.ResponseWriter, r *http.Request) {
	...
	svcErr := h.resourceService.DeleteResource(r.Context(), rsID, id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionListAtResourceServerRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetActionList(r.Context(), rsID, nil, limit, offset)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionPostAtResourceServerRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.CreateAction(r.Context(), rsID, nil, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionGetAtResourceServerRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetAction(r.Context(), rsID, nil, id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionPutAtResourceServerRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.UpdateAction(r.Context(), rsID, nil, id, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionDeleteAtResourceServerRequest(w http.ResponseWriter, r *http.Request) {
	...
	svcErr := h.resourceService.DeleteAction(r.Context(), rsID, nil, id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionListAtResourceRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetActionList(r.Context(), rsID, &resourceID, limit, offset)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionPostAtResourceRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.CreateAction(r.Context(), rsID, &resourceID, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionGetAtResourceRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.GetAction(r.Context(), rsID, &resourceID, id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionPutAtResourceRequest(w http.ResponseWriter, r *http.Request) {
	...
	result, svcErr := h.resourceService.UpdateAction(r.Context(), rsID, &resourceID, id, serviceReq)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
...
func (h *resourceHandler) HandleActionDeleteAtResourceRequest(w http.ResponseWriter, r *http.Request) {
	...
	svcErr := h.resourceService.DeleteAction(r.Context(), rsID, &resourceID, id)
	if svcErr != nil {
		handleError(w, svcErr)
		return
	}
