...
func (_mock *UserServiceInterfaceMock) GetUserList(ctx context.Context, limit int, offset int, filters map[string]interface{}, excludeGroupID string) (*UserListResponse, *serviceerror.ServiceError) {
	...
	var r1 *serviceerror.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, int, map[string]interface{}, string) (*UserListResponse, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, limit, offset, filters, excludeGroupID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, int, map[string]interface{}, string) *UserListResponse); ok {
...
func (_c *UserServiceInterfaceMock_GetUserList_Call) RunAndReturn(run func(ctx context.Context, limit int, offset int, filters map[string]interface{}, excludeGroupID string) (*UserListResponse, *serviceerror.ServiceError)) *UserServiceInterfaceMock_GetUserList_Call {
	_c.Call.Return(run)
	return _c
}

// GetUsersByPath provides a mock function for the type UserServiceInterfaceMock
func (_mock *UserServiceInterfaceMock) GetUsersByPath(ctx context.Context, handlePath string, limit int, offset int, filters map[string]interface{}, excludeGroupID string) (*UserListResponse, *serviceerror.ServiceError) {
	...
	var r0 *UserListResponse
	var r1 *serviceerror.ServiceError
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, int, int, map[string]interface{}, string) (*UserListResponse, *serviceerror.ServiceError)); ok {
		return returnFunc(ctx, handlePath, limit, offset, filters, excludeGroupID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, int, int, map[string]interface{}, string) *UserListResponse); ok {
...
func (_c *UserServiceInterfaceMock_GetUsersByPath_Call) RunAndReturn(run func(ctx context.Context, handlePath string, limit int, offset int, filters map[string]interface{}, excludeGroupID string) (*UserListResponse, *serviceerror.ServiceError)) *UserServiceInterfaceMock_GetUsersByPath_Call {
	_c.Call.Return(run)
	return _c
}
