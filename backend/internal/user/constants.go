...
var SupportedCredentialTypes = map[CredentialType]struct{}{
...
func (ct CredentialType) IsValid() bool {
	_, ok := SupportedCredentialTypes[ct]
	return ok
}

// RequiresHashing checks if this credential type requires hashing
func (ct CredentialType) RequiresHashing() bool {
	return ct == CredentialTypePassword || ct == CredentialTypePin || ct == CredentialTypeSecret
}
