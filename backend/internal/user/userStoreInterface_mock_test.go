...
func (_mock *userStoreInterfaceMock) CreateUser(user User, credentials CredentialMap) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(User, CredentialMap) error); ok {
...
func (_c *userStoreInterfaceMock_CreateUser_Call) Run(run func(user User, credentials CredentialMap)) *userStoreInterfaceMock_CreateUser_Call {
...
func (_c *userStoreInterfaceMock_CreateUser_Call) RunAndReturn(run func(user User, credentials CredentialMap) error) *userStoreInterfaceMock_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) GetCredentials(id string) (User, CredentialMap, error) {
	ret := _mock.Called(id)
...
func (_c *userStoreInterfaceMock_GetCredentials_Call) Return(user User, credentialMap CredentialMap, err error) *userStoreInterfaceMock_GetCredentials_Call {
	_c.Call.Return(user, credentialMap, err)
	return _c
}

func (_c *userStoreInterfaceMock_GetCredentials_Call) RunAndReturn(run func(id string) (User, CredentialMap, error)) *userStoreInterfaceMock_GetCredentials_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) UpdateUserCredentials(userID string, credentials CredentialMap) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(string, CredentialMap) error); ok {
...
func (_c *userStoreInterfaceMock_UpdateUserCredentials_Call) Run(run func(userID string, credentials CredentialMap)) *userStoreInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *userStoreInterfaceMock_UpdateUserCredentials_Call) RunAndReturn(run func(userID string, credentials CredentialMap) error) *userStoreInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
