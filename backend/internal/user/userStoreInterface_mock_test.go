...
func (_mock *userStoreInterfaceMock) CreateUser(ctx context.Context, user User, credentials []Credential) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, User, []Credential) error); ok {
...
func (_c *userStoreInterfaceMock_CreateUser_Call) Run(run func(ctx context.Context, user User, credentials []Credential)) *userStoreInterfaceMock_CreateUser_Call {
...
func (_c *userStoreInterfaceMock_CreateUser_Call) RunAndReturn(run func(ctx context.Context, user User, credentials []Credential) error) *userStoreInterfaceMock_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) GetCredentials(ctx context.Context, id string) (User, []Credential, error) {
	ret := _mock.Called(ctx, id)
	...
	var r1 []Credential
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) (User, []Credential, error)); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string) []Credential); ok {
...
func (_c *userStoreInterfaceMock_GetCredentials_Call) RunAndReturn(run func(ctx context.Context, id string) (User, []Credential, error)) *userStoreInterfaceMock_GetCredentials_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) UpdateUserCredentials(ctx context.Context, userID string, credentials []Credential) error {
...
func (_c *userStoreInterfaceMock_UpdateUserCredentials_Call) Run(run func(ctx context.Context, userID string, credentials []Credential)) *userStoreInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *userStoreInterfaceMock_UpdateUserCredentials_Call) RunAndReturn(run func(ctx context.Context, userID string, credentials []Credential) error) *userStoreInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
