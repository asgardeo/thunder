...
func (_mock *GithubOAuthAuthnServiceInterfaceMock) GetInternalUser(ctx context.Context, sub string) (*user.User, *serviceerror.ServiceError) {
...
//   - ctx context.Context
//   - sub string
func (_e *GithubOAuthAuthnServiceInterfaceMock_Expecter) GetInternalUser(ctx interface{}, sub interface{}) *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call {
	return &GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call{Call: _e.mock.On("GetInternalUser", ctx, sub)}
}

func (_c *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call) Run(run func(ctx context.Context, sub string)) *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call) RunAndReturn(run func(ctx context.Context, sub string) (*user.User, *serviceerror.ServiceError)) *GithubOAuthAuthnServiceInterfaceMock_GetInternalUser_Call {
	_c.Call.Return(run)
	return _c
}
