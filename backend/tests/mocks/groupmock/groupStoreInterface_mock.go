...
func (_mock *groupStoreInterfaceMock) GetGroupListExcluding(ctx context.Context, excludeGroupID string, limit int, offset int) ([]group.GroupBasicDAO, error) {
...
func (_c *groupStoreInterfaceMock_GetGroupListExcluding_Call) Return(groupBasicDAOs []group.GroupBasicDAO, err error) *groupStoreInterfaceMock_GetGroupListExcluding_Call {
	_c.Call.Return(groupBasicDAOs, err)
	return _c
}

func (_c *groupStoreInterfaceMock_GetGroupListExcluding_Call) RunAndReturn(run func(ctx context.Context, excludeGroupID string, limit int, offset int) ([]group.GroupBasicDAO, error)) *groupStoreInterfaceMock_GetGroupListExcluding_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *groupStoreInterfaceMock) GetGroupMemberIDsByType(ctx context.Context, groupID string, memberType group.MemberType) ([]string, error) {
	...
	var r0 []string
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, group.MemberType) ([]string, error)); ok {
		return returnFunc(ctx, groupID, memberType)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string, group.MemberType) []string); ok {
	...
	if returnFunc, ok := ret.Get(1).(func(context.Context, string, group.MemberType) error); ok {
...
func (_c *groupStoreInterfaceMock_GetGroupMemberIDsByType_Call) Run(run func(ctx context.Context, groupID string, memberType group.MemberType)) *groupStoreInterfaceMock_GetGroupMemberIDsByType_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *groupStoreInterfaceMock_GetGroupMemberIDsByType_Call) RunAndReturn(run func(ctx context.Context, groupID string, memberType group.MemberType) ([]string, error)) *groupStoreInterfaceMock_GetGroupMemberIDsByType_Call {
	_c.Call.Return(run)
	return _c
}
