...
func (_mock *UserServiceInterfaceMock) UpdateUserCredentials(userID string, credentialType string, credentials []user.Credential) *serviceerror.ServiceError {
...
func (_c *UserServiceInterfaceMock_UpdateUserCredentials_Call) Run(run func(userID string, credentialType string, credentials []user.Credential)) *UserServiceInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *UserServiceInterfaceMock_UpdateUserCredentials_Call) RunAndReturn(run func(userID string, credentialType string, credentials []user.Credential) *serviceerror.ServiceError) *UserServiceInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
