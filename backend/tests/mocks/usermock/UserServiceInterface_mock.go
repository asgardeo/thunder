...
func (_mock *UserServiceInterfaceMock) UpdateUserCredentials(ctx context.Context, userID string, attributes json.RawMessage) *serviceerror.ServiceError {
	ret := _mock.Called(ctx, userID, attributes)
...
//   - userID string
//   - attributes json.RawMessage
func (_e *UserServiceInterfaceMock_Expecter) UpdateUserCredentials(ctx interface{}, userID interface{}, attributes interface{}) *UserServiceInterfaceMock_UpdateUserCredentials_Call {
	return &UserServiceInterfaceMock_UpdateUserCredentials_Call{Call: _e.mock.On("UpdateUserCredentials", ctx, userID, attributes)}
}

func (_c *UserServiceInterfaceMock_UpdateUserCredentials_Call) Run(run func(ctx context.Context, userID string, attributes json.RawMessage)) *UserServiceInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *UserServiceInterfaceMock_UpdateUserCredentials_Call) RunAndReturn(run func(ctx context.Context, userID string, attributes json.RawMessage) *serviceerror.ServiceError) *UserServiceInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
