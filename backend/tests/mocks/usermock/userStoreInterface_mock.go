...
func (_mock *userStoreInterfaceMock) CreateUser(user1 user.User, credentials user.CredentialMap) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(user.User, user.CredentialMap) error); ok {
...
//   - user1 user.User
//   - credentials user.CredentialMap
...
func (_c *userStoreInterfaceMock_CreateUser_Call) Run(run func(user1 user.User, credentials user.CredentialMap)) *userStoreInterfaceMock_CreateUser_Call {
...
func (_c *userStoreInterfaceMock_CreateUser_Call) RunAndReturn(run func(user1 user.User, credentials user.CredentialMap) error) *userStoreInterfaceMock_CreateUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) GetCredentials(id string) (user.User, user.CredentialMap, error) {
	ret := _mock.Called(id)
	...
	var r2 error
	if returnFunc, ok := ret.Get(0).(func(string) (user.User, user.CredentialMap, error)); ok {
...
func (_c *userStoreInterfaceMock_GetCredentials_Call) Return(user1 user.User, credentialMap user.CredentialMap, err error) *userStoreInterfaceMock_GetCredentials_Call {
	_c.Call.Return(user1, credentialMap, err)
	return _c
}

func (_c *userStoreInterfaceMock_GetCredentials_Call) RunAndReturn(run func(id string) (user.User, user.CredentialMap, error)) *userStoreInterfaceMock_GetCredentials_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) UpdateUserCredentials(userID string, credentials user.CredentialMap) error {
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(string, user.CredentialMap) error); ok {
...
func (_c *userStoreInterfaceMock_UpdateUserCredentials_Call) Run(run func(userID string, credentials user.CredentialMap)) *userStoreInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 string
		if args[0] != nil {
			arg0 = args[0].(string)
...
func (_c *userStoreInterfaceMock_UpdateUserCredentials_Call) RunAndReturn(run func(userID string, credentials user.CredentialMap) error) *userStoreInterfaceMock_UpdateUserCredentials_Call {
	_c.Call.Return(run)
	return _c
}
