...
func (_mock *userStoreInterfaceMock) GetTransitiveUserGroups(ctx context.Context, userID string) ([]user.UserGroup, error) {
	ret := _mock.Called(ctx, userID)
	...
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) ([]user.UserGroup, error)); ok {
		return returnFunc(ctx, userID)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, string) []user.UserGroup); ok {
		r0 = returnFunc(ctx, userID)
	} else {
		if ret.Get(0) != nil {
...
func (_c *userStoreInterfaceMock_GetTransitiveUserGroups_Call) Return(userGroups []user.UserGroup, err error) *userStoreInterfaceMock_GetTransitiveUserGroups_Call {
	_c.Call.Return(userGroups, err)
	return _c
}

func (_c *userStoreInterfaceMock_GetTransitiveUserGroups_Call) RunAndReturn(run func(ctx context.Context, userID string) ([]user.UserGroup, error)) *userStoreInterfaceMock_GetTransitiveUserGroups_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) GetUserListByOUIDs(ctx context.Context, ouIDs []string, limit int, offset int, filters map[string]interface{}) ([]user.User, error) {
	...
	var r0 []user.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, int, int, map[string]interface{}) ([]user.User, error)); ok {
		return returnFunc(ctx, ouIDs, limit, offset, filters)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, []string, int, int, map[string]interface{}) []user.User); ok {
...
func (_c *userStoreInterfaceMock_GetUserListByOUIDs_Call) Return(users []user.User, err error) *userStoreInterfaceMock_GetUserListByOUIDs_Call {
	_c.Call.Return(users, err)
	return _c
}

func (_c *userStoreInterfaceMock_GetUserListByOUIDs_Call) RunAndReturn(run func(ctx context.Context, ouIDs []string, limit int, offset int, filters map[string]interface{}) ([]user.User, error)) *userStoreInterfaceMock_GetUserListByOUIDs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *userStoreInterfaceMock) SearchUsers(ctx context.Context, filters map[string]interface{}) ([]user.User, error) {
	ret := _mock.Called(ctx, filters)
	...
	var r0 []user.User
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, map[string]interface{}) ([]user.User, error)); ok {
		return returnFunc(ctx, filters)
	}
...
func (_c *userStoreInterfaceMock_SearchUsers_Call) Return(users []user.User, err error) *userStoreInterfaceMock_SearchUsers_Call {
	_c.Call.Return(users, err)
	return _c
}

func (_c *userStoreInterfaceMock_SearchUsers_Call) RunAndReturn(run func(ctx context.Context, filters map[string]interface{}) ([]user.User, error)) *userStoreInterfaceMock_SearchUsers_Call {
	_c.Call.Return(run)
	return _c
}
