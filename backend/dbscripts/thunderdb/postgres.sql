...
CREATE TABLE "USER" (
    ...
    ATTRIBUTES  JSONB,
    CREDENTIALS JSONB,
    INDEXED_PROP_1_VALUE VARCHAR(50),
    INDEXED_PROP_2_VALUE VARCHAR(50),
    INDEXED_PROP_3_VALUE VARCHAR(50),
    INDEXED_PROP_4_VALUE VARCHAR(50),
    INDEXED_PROP_5_VALUE VARCHAR(50),
    CREATED_AT  TIMESTAMPTZ DEFAULT NOW(),
    UPDATED_AT  TIMESTAMPTZ DEFAULT NOW()
);

CREATE INDEX idx_user_indexed_prop_1_value ON "USER" (INDEXED_PROP_1_VALUE);
CREATE INDEX idx_user_indexed_prop_2_value ON "USER" (INDEXED_PROP_2_VALUE);
CREATE INDEX idx_user_indexed_prop_3_value ON "USER" (INDEXED_PROP_3_VALUE);
CREATE INDEX idx_user_indexed_prop_4_value ON "USER" (INDEXED_PROP_4_VALUE);
CREATE INDEX idx_user_indexed_prop_5_value ON "USER" (INDEXED_PROP_5_VALUE);
...
CREATE TABLE USER_SCHEMAS (
    ...
    INDEXED_PROP_1_NAME VARCHAR(50),
    INDEXED_PROP_2_NAME VARCHAR(50),
    INDEXED_PROP_3_NAME VARCHAR(50),
    INDEXED_PROP_4_NAME VARCHAR(50),
    INDEXED_PROP_5_NAME VARCHAR(50),
    CREATED_AT  TIMESTAMPTZ DEFAULT NOW(),
    UPDATED_AT  TIMESTAMPTZ DEFAULT NOW()
);
