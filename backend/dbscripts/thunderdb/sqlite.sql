...
CREATE TABLE ROLE_PERMISSION (
    ID                  INTEGER PRIMARY KEY AUTOINCREMENT,
    DEPLOYMENT_ID       VARCHAR(255) NOT NULL,
    ROLE_INTERNAL_ID    INTEGER NOT NULL,
    RESOURCE_SERVER_ID  VARCHAR(36) NOT NULL,
    PERMISSION          VARCHAR(100) NOT NULL,
    CREATED_AT          TEXT DEFAULT (datetime('now')),
    FOREIGN KEY (ROLE_INTERNAL_ID, DEPLOYMENT_ID) REFERENCES "ROLE" (ID, DEPLOYMENT_ID) ON DELETE CASCADE,
    CONSTRAINT unique_role_permission UNIQUE (ROLE_INTERNAL_ID, RESOURCE_SERVER_ID, PERMISSION, DEPLOYMENT_ID)
);
...
CREATE TABLE ROLE_ASSIGNMENT (
    ...
    UPDATED_AT      TEXT DEFAULT (datetime('now')),
    FOREIGN KEY (ROLE_INTERNAL_ID, DEPLOYMENT_ID) REFERENCES "ROLE" (ID, DEPLOYMENT_ID) ON DELETE CASCADE,
    CONSTRAINT unique_role_assignment UNIQUE (ROLE_INTERNAL_ID, ASSIGNEE_TYPE, ASSIGNEE_ID, DEPLOYMENT_ID)
);
...
ON ROLE_PERMISSION (ROLE_INTERNAL_ID, DEPLOYMENT_ID);
