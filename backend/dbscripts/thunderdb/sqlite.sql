...
CREATE TABLE ROLE_PERMISSION (
    ...
    FOREIGN KEY (ROLE_ID, DEPLOYMENT_ID) REFERENCES "ROLE" (ID, DEPLOYMENT_ID) ON DELETE CASCADE
);
...
CREATE TABLE APPLICATION (
    ...
    APP_JSON TEXT,
    UNIQUE (ID, DEPLOYMENT_ID),
    FOREIGN KEY (THEME_ID, DEPLOYMENT_ID) REFERENCES THEME(ID, DEPLOYMENT_ID) ON DELETE RESTRICT,
    FOREIGN KEY (LAYOUT_ID, DEPLOYMENT_ID) REFERENCES LAYOUT(ID, DEPLOYMENT_ID) ON DELETE RESTRICT
);
...
CREATE TABLE APP_OAUTH_INBOUND_CONFIG (
    ...
    FOREIGN KEY (APP_ID, DEPLOYMENT_ID) REFERENCES APPLICATION(ID, DEPLOYMENT_ID) ON DELETE CASCADE
);
...
CREATE TABLE FLOW_VERSION (
    ...
    FOREIGN KEY (FLOW_ID, DEPLOYMENT_ID)
        REFERENCES FLOW(FLOW_ID, DEPLOYMENT_ID)
        ON DELETE CASCADE
);
