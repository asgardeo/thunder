...
CREATE TABLE "AUTHORIZATION_CODE" (
    ...
    AUTHZ_DATA TEXT NOT NULL CHECK (length(AUTHZ_DATA) <= 8192),
...
CREATE TABLE "AUTHORIZATION_REQUEST" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    REQUEST_DATA TEXT NOT NULL CHECK (length(REQUEST_DATA) <= 8192),
    EXPIRY_TIME DATETIME NOT NULL,
...
CREATE TABLE "FLOW_CONTEXT" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    CONTEXT TEXT CHECK (CONTEXT IS NULL OR length(CONTEXT) <= 262144),
    EXPIRY_TIME DATETIME NOT NULL,
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "WEBAUTHN_SESSION" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    SESSION_DATA TEXT NOT NULL CHECK (length(SESSION_DATA) <= 8192),
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    EXPIRY_TIME DATETIME NOT NULL,
...
CREATE TABLE "ATTRIBUTE_CACHE" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    ATTRIBUTES TEXT NOT NULL CHECK (length(ATTRIBUTES) <= 65536),
    EXPIRY_TIME DATETIME NOT NULL,
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "PAR_REQUEST" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    REQUEST_PARAMS TEXT NOT NULL CHECK (length(REQUEST_PARAMS) <= 8192),
    EXPIRY_TIME DATETIME NOT NULL
);
