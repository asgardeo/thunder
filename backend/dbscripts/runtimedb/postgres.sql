...
CREATE TABLE "AUTHORIZATION_CODE" (
    ...
    AUTHZ_DATA JSONB NOT NULL CHECK (octet_length(AUTHZ_DATA::text) <= 8192),
...
CREATE TABLE "AUTHORIZATION_REQUEST" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    REQUEST_DATA JSONB NOT NULL CHECK (octet_length(REQUEST_DATA::text) <= 8192),
    EXPIRY_TIME TIMESTAMP NOT NULL,
...
CREATE TABLE "FLOW_CONTEXT" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    CONTEXT JSONB CHECK (CONTEXT IS NULL OR octet_length(CONTEXT::text) <= 262144),
    EXPIRY_TIME TIMESTAMP NOT NULL,
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE "WEBAUTHN_SESSION" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    SESSION_DATA JSONB NOT NULL CHECK (octet_length(SESSION_DATA::text) <= 8192),
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    EXPIRY_TIME TIMESTAMP NOT NULL,
...
CREATE TABLE "ATTRIBUTE_CACHE" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    ATTRIBUTES JSONB NOT NULL CHECK (octet_length(ATTRIBUTES::text) <= 65536),
    EXPIRY_TIME TIMESTAMP NOT NULL,
    CREATED_AT TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE "PAR_REQUEST" (
    ...
    DEPLOYMENT_ID VARCHAR(255) NOT NULL,
    REQUEST_PARAMS JSONB NOT NULL CHECK (octet_length(REQUEST_PARAMS::text) <= 8192),
    EXPIRY_TIME TIMESTAMP NOT NULL
);
