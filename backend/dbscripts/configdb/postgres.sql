...
CREATE TABLE "ENTITY_TYPES" (
    ...
    SCHEMA_DEF  JSONB NOT NULL CHECK (octet_length(SCHEMA_DEF::text) <= 65536),
...
CREATE TABLE "THEME" (
    ...
    THEME JSONB NOT NULL CHECK (octet_length(THEME::text) <= 1048576),
    CREATED_AT TIMESTAMPTZ DEFAULT NOW(),
    UPDATED_AT TIMESTAMPTZ DEFAULT NOW(),
...
CREATE TABLE "LAYOUT" (
    ...
    HANDLE VARCHAR(255) NOT NULL,
    DESCRIPTION VARCHAR(512),
    LAYOUT JSONB NOT NULL CHECK (octet_length(LAYOUT::text) <= 1048576),
    CREATED_AT TIMESTAMPTZ DEFAULT NOW(),
    UPDATED_AT TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE (DEPLOYMENT_ID, HANDLE)
);
...
CREATE TABLE "INBOUND_CLIENT" (
    ...
    PROPERTIES JSONB CHECK (PROPERTIES IS NULL OR octet_length(PROPERTIES::text) <= 32768),
...
CREATE TABLE "OAUTH_INBOUND_PROFILE" (
    ...
    OAUTH_CONFIG JSONB CHECK (OAUTH_CONFIG IS NULL OR octet_length(OAUTH_CONFIG::text) <= 32768),
...
CREATE TABLE "IDP" (
    ...
    PROPERTIES JSONB CHECK (PROPERTIES IS NULL OR octet_length(PROPERTIES::text) <= 65536),
    CREATED_AT TIMESTAMPTZ DEFAULT NOW(),
    UPDATED_AT TIMESTAMPTZ DEFAULT NOW()
);
...
CREATE TABLE "FLOW_VERSION" (
    ...
    NODES JSONB NOT NULL CHECK (octet_length(NODES::text) <= 1048576),
    CREATED_AT TIMESTAMPTZ DEFAULT NOW(),
