  ...
  return (
    ...
    >
      ...
      >
        ...
        <Tooltip title={isDisabled ? t('layouts.config.custom_css.actions.show_in_preview.tooltip', 'Show in preview') : t('layouts.config.custom_css.actions.hide_from_preview.tooltip', 'Hide from preview')} placement="top">
          <Box
            component="span"
            role="button"
            tabIndex={0}
            aria-label={isDisabled ? t('layouts.config.custom_css.actions.show_in_preview.tooltip', 'Show in preview') : t('layouts.config.custom_css.actions.hide_from_preview.tooltip', 'Hide from preview')}
            onClick={(e) => {
              e.stopPropagation();
