...
import type {UrlStylesheet} from '@thunder/shared-design';
...
function UrlField({sheet, onUpdate}: UrlFieldProps): JSX.Element {
  ...
  if (hasError) helperText = t('layouts.config.custom_css.fields.url.errors.invalid_url', 'URL must be a valid http:// or https:// address');
  else if (isInsecure) helperText = t('layouts.config.custom_css.fields.url.warnings.insecure_protocol', 'Using HTTP is insecure. Consider using HTTPS instead.');
