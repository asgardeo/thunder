...
import {Autocomplete, Box, Link, Stack, TextField, Typography, type AutocompleteRenderInputParams} from '@wso2/oxygen-ui';
...
const VARIANT_WEIGHT_REF: Record<string, 'fontWeightLight' | 'fontWeightRegular' | 'fontWeightMedium' | 'fontWeightBold'> = {
  h1: 'fontWeightLight',
  h2: 'fontWeightLight',
...
const VARIANT_KEYS = ['h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'subtitle1', 'subtitle2', 'body1', 'body2', 'button', 'caption', 'overline'];
        ...
        <Autocomplete
          ...
          renderInput={(params: AutocompleteRenderInputParams) => (
            <TextField
              {...params}
              size="small"
              placeholder={t('themes.forms.typography_builder.fields.font_family.placeholder', 'e.g. Inter, Arial, sans-serif')}
              helperText={t('themes.forms.typography_builder.fields.font_family.helper_text', 'Choose a preset or type any CSS font stack')}
            />
          )}
          sx={{mb: 1.5}}
        />
      ...
      <ConfigCard
        ...
        action={
          <Link
            ...
            sx={{fontSize: '0.7rem', mr: 1, cursor: 'pointer'}}
          >
