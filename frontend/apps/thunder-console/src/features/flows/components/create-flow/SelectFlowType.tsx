...
import {KeyRound, UserPlus, Users} from '@wso2/oxygen-ui-icons-react';
...
export default function SelectFlowType({selectedType, onTypeChange, onReadyChange}: SelectFlowTypeProps): JSX.Element {
  ...
  const options: FlowTypeOption[] = [
    ...
    {
      type: FlowType.USER_ONBOARDING,
      labelKey: 'flows:create.type.onboarding.label',
      labelDefault: 'Onboarding',
      descriptionKey: 'flows:create.type.onboarding.description',
      descriptionDefault: 'Onboard invited users to your organization',
      icon: <Users size={28} />,
    },
  ];
