...
import {Stack, TextField, Button, IconButton, Typography} from '@wso2/oxygen-ui';
 ...
 * Displays Quick Copy, Organization Unit, and Danger Zone sections.
 */
export default function EditGeneralSettings({group, onDeleteClick}: EditGeneralSettingsProps): JSX.Element {
  ...
  return (
    <Stack spacing={3}>
      {/* Quick Copy */}
      <SettingsCard
        title={t('groups:edit.general.sections.quickCopy.title')}
        description={t('groups:edit.general.sections.quickCopy.description')}
      >
        <Stack spacing={2}>
          <Stack direction="row" alignItems="center" spacing={1}>
            <TextField
              label={t('groups:edit.general.sections.quickCopy.groupId')}
              value={group.id}
              fullWidth
              size="small"
            ...
            <IconButton
              size="small"
              aria-label={t('groups:edit.general.sections.quickCopy.copyGroupId')}
              onClick={() => {
