 ...
 */
export default function ManageMembersSection({groupId, onRemoveMember}: ManageMembersSectionProps): JSX.Element {
  const {t} = useTranslation();
  const theme = useTheme();
  const dataGridLocaleText = useDataGridLocaleText();
  const {data: membersData, isLoading} = useGetGroupMembers(groupId);
