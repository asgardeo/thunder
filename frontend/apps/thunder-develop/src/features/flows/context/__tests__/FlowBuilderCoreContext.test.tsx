...
describe('FlowBuilderCoreContext', () => {
  describe('default context values', () => {
    it('should have correct default values when accessed without provider', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have correct default string values', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have correct default object values', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have correct default undefined values', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have correct default null values', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));

      expect(result.current.resourcePropertiesPanelHeading).toBeNull();
    });

    it('should have correct default enum values', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have default function stubs that do not throw', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have default isCustomI18nKey function that returns false', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have default ElementFactory component that returns null', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have default ResourceProperties component that returns null', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
    ...
    it('should have lastInteractedResource as empty object', async () => {
      const {result} = await renderHook(() => useContext(FlowBuilderCoreContext));
