...
// PERFORMANCE: External store for flow builder core state to allow fine-grained subscriptions
 ...
 * PERFORMANCE: Components using this won't re-render when other context values change.
 */
