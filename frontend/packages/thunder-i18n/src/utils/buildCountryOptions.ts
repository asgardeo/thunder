...
export type CountryOption = {
  ...
  regionCode: string;
  /** English display name resolved via Intl.DisplayNames, e.g. "France". */
  name: string;
  /** Flag emoji derived from the region code. */
  flag: string;
};

/**
 * Build a sorted list of {@link CountryOption} derived from {@link REGION_LOCALES},
 * with display names resolved via {@link Intl.DisplayNames}.
 */
