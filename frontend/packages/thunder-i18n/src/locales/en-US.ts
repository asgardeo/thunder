...
const translations = {
  ...
  groups: {
    ...
    'edit.general.sections.dangerZone.deleteGroupDescription':
    ...
    'delete.disclaimer':
      'This action cannot be undone. All group associations will be permanently removed.',
  },
  ...
  applications: {
    ...
    'edit.token.userInfoAttributes.description':
