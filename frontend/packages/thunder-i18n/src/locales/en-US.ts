...
const translations = {
  ...
  applications: {
    ...
    'onboarding.configure.SignInOptions.flowNotAvailable': 'Authentication flow not available',
    'onboarding.configure.SignInOptions.orDivider': 'Or',
    'onboarding.configure.SignInOptions.selectExistingFlow': 'Select an existing flow',
    'onboarding.configure.SignInOptions.none': 'None',
    'onboarding.configure.SignInOptions.noFlowsFound': 'No flows found',
    'onboarding.configure.SignInOptions.clear': 'Clear',
    'onboarding.preview.customFlowSelected': 'Custom Flow Selected',
    'onboarding.preview.customFlowHint': 'Preview is not available for custom flows. Open the Flows to preview.',
    'onboarding.errors.flowNotFound': 'Authentication flow not found: {{flowHandle}}. Please ensure all required flows are configured.',
