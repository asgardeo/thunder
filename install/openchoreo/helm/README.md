...
|-------|-------------|---------|
| `image` | ThunderID container image (`repository:tag`) | `ghcr.io/thunder-id/thunder-id:latest` |
...
| `thunderid-component.image.repository` | ThunderID container image repository | `ghcr.io/thunder-id/thunder-id` |
...
- Open an issue in the [ThunderID GitHub repository](https://github.com/thunder-id/thunder-id)
