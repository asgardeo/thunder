      ...
      sx={{
        ...
        background: (theme) =>
          theme.palette.mode === 'dark'
            ? 'linear-gradient(135deg, rgba(255, 107, 0, 0.08) 0%, rgba(99, 102, 241, 0.06) 100%)'
            : 'linear-gradient(135deg, rgba(255, 107, 0, 0.06) 0%, rgba(99, 102, 241, 0.04) 100%)',
        display: 'flex',
        alignItems: 'center',
  ...
  return (
    <Box
      sx={{
        ...
        background: (theme) =>
          theme.palette.mode === 'dark'
            ? 'linear-gradient(135deg, rgba(99, 102, 241, 0.08) 0%, rgba(255, 107, 0, 0.06) 100%)'
            : 'linear-gradient(135deg, rgba(99, 102, 241, 0.06) 0%, rgba(255, 107, 0, 0.04) 100%)',
        display: 'flex',
        alignItems: 'center',
        justifyContent: 'center',
        position: 'relative',
    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: 1,
          bgcolor: (theme) =>
            theme.palette.mode === 'dark' ? 'rgba(255, 107, 0, 0.15)' : 'rgba(255, 107, 0, 0.1)',
          border: '1px solid',
      ...
      <Box
        sx={{
          ...
          borderRadius: 1,
          bgcolor: (theme) =>
            theme.palette.mode === 'dark' ? 'rgba(255, 107, 0, 0.1)' : 'rgba(255, 107, 0, 0.07)',
          border: '1px solid',
        ...
        >
          ...
          >
            ...
            <Box sx={{p: 3}}>
              ...
              <Typography variant="body2" color="text.secondary" sx={{mb: 3, fontSize: '0.85rem', lineHeight: 1.6}}>
