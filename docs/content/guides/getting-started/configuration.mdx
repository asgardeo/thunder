...
The system resource server controls administrative permissions for <ProductName /> operations such as managing users, groups, organization units, and user schemas. You can customize the handle and identifier to fit your deployment requirements.
