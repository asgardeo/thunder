...
<TutorialHeroItem icon={<Server />}>A Thunder application and Client ID. See the <a href="quickstart-guide">Getting Started guide</a> for instructions</TutorialHeroItem>
