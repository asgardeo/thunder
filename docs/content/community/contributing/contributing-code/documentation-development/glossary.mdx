...
title: Glossary
sidebar_position: 10
description: Definitions of key terms and concepts used in Thunder
---
...
A permission boundary that limits what an application can access. Thunder supports the following OIDC scopes: `openid`, `profile`, `email`, `phone`, `address`, and `roles`. The `system` scope grants access to Thunder management APIs.
