...
| Channel | When to use |
|---------|-------------|
| [GitHub Discussions - Q&A](https://github.com/asgardeo/thunder/discussions/new?category=q-a) | General questions about Thunder |
| [GitHub Discussions - Ideas](https://github.com/asgardeo/thunder/discussions/new?category=ideas) | Exploring ideas and problems |
| [GitHub Discussions - General](https://github.com/asgardeo/thunder/discussions/new?category=general) | Anything else |
