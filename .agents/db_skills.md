...
|--------------|------------------------------------------------------------------------|
| `configdb`   | Configuration domain data: applications, authentication flows, roles, identity providers |
| `runtimedb`  | Runtime temporal state: authorization codes, flow contexts, WebAuthn sessions |
